...
## 🎮 Project Overview
This is a 3D Unity-based game simulating a DJ/Producer experience. The player follows musical notes and performs rhythmic actions, receiving visual and audio feedback. The game includes scoring, single and multiplayer support, and is designed to enhance timing, coordination, and musical responsiveness.

---

## 🧠 Game Objectives
- Provide a fun and educational music-learning experience.
- Train hand-eye coordination and rhythm through gameplay, skills which are needed for real life DJing and producing of electronic music.
- Simulate a DJ like environment for beginners who are interested in the craft.
- Promote healthy competition via live scoring and leaderboards.
- Develop intuition for rhythmic improvisation.
...
## 🕹️ How to Play
1. Launch the app and select a game mode (Single/Multiplayer).
2. Notes appear according to the beat – match them using button/slider actions.
3. Accurate timing increases your score, missed beats reduce it.
4. Check the leaderboard to improve your performance.

---

## ⚙️ Technologies Used
- **Unity (C#)** – Core game engine.
- **Firebase** – Player authentication, score tracking, and cloud storage.
- **Timeline System** – Synchronizes animations and beats.
- **Audio Mixer** – Controls volume, effects, and transitions.
- **Unity UI Toolkit** – UI design and user interaction.
